...
function [dlc_cell, turbsim_trig] = wind_config_IMP(dlc_cell,row) 
...
imp = erase(dlc_cell{row,find_label_or_create(dlc_cell,'Wind-Type',true)},'IMP:'); 
